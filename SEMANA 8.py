...
def mostrar_codigo(ruta_script):
    """
    Muestra el código de un script Python.
    """
...
def ejecutar_codigo(ruta_script):
    """
    Ejecuta el script Python usando subprocess.
    """
    try:
...
def mostrar_menu():
    """
    Muestra el menú principal para la selección de unidades.
    """
...
def mostrar_sub_menu(ruta_unidad):
    """
    Muestra un submenú con las subcarpetas dentro de la unidad seleccionada.
    """
...
def mostrar_scripts(ruta_sub_carpeta):
    """
    Muestra los scripts Python dentro de la subcarpeta seleccionada.
    """
